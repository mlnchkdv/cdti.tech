            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center">
              <div className="flex-1">
                ...
                <p className="text-lg md:text-xl text-foreground font-medium leading-relaxed tracking-tight mb-6">
                  "Комитет по развитию цифровых технологий и инноваций при ТПП Саратовской области — это практический
                   элемент региональной инновационной инфраструктуры: мы соединяем запрос бизнеса, компетенции науки и
                    образования и возможности институтов развития, чтобы ускорять внедрение “сквозных” технологий — от
                     IIoT и ИИ до кибербезопасности и подготовки кадров. Наша задача — формировать консолидированную
                      позицию предпринимательского сообщества, переводить её в решения и проекты, которые прямо
                       повышают конкурентоспособность предприятий и экономики региона."
                </p>
